...
/// khi nhấn vào nút này thi gửi request xóa
...
/// khi nhấn vào bài đăng thì gửi post request 
...
function outputPostsWithReplies(results, container) {
  ...
  results.replies.forEach(async (result) => {
    var html = createPostHtml(result);
    await container.append(html);
  });
}
...
$(document).on("click", "#markNotificationsAsRead",()=>{
